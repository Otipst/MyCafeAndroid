 ...
 * Use the {@link admin_fragment#newInstance} factory method to
...
public class admin_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater
                .inflate(R.layout.fragment_admin, container, false);
    ...
    private void configureImageButton(View view) {
        ...
        ImageView btn = (ImageView) view.findViewById(R.id.admin);

        btn.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), SignInAdminActivity.class);
